    ...
    return (
        <div className="navbar bg-[#fff0e7] text-black">
            <div className="navbar-start">
                ...
                <a className="btn text-black bg-[#fff0e7] hover:bg-[#fff0e7] text-base hover:text-orange-300">Our Library</a>
            </div>
            ...
            <div className="navbar-end">
                <a className="btn text-base text-black bg-[#fff0e7] hover:bg-[#fff0e7] hover:text-orange-300">Login</a>
            </div>
        </div>
    );
};
