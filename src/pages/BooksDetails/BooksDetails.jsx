    ...
    return (
        <div >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 max-w-3xl mx-auto bg-slate-600 items-center my-6 rounded ">
                <div className="p-6">
                    <img className="w-full h-96 rounded" src={books} alt="" />
                </div>
                <div className="p-6 space-y-4 text-white">
                    <h1 className="text-2xl font-semibold">Book name</h1>
                    <p>Book Title</p>
                    <p>By - Author Name</p>
                    <p >Category: <span className="px-3 py-2 bg-amber-100 text-black rounded">Science Fiction</span></p>
                    <p>In Stock : 50 Copies Available</p>
